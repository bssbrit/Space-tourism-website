...
crewlist.forEach((item) => {
  item.addEventListener("click", () => {
    renderCrew(item.value);
  });
});

let techlist = document.querySelectorAll("#techOptions button");
techlist.forEach((item) => {
  item.addEventListener("click", () => {
    renderTech(item.value);
  });
});
...
const renderPlanet = (itemValue) => {
  ...
  planetImg.src = objeto.destinations[itemValue].images.png;
  let planetName = document.getElementById("planetName");
  planetName.textContent = objeto.destinations[itemValue].name;
  let planetDescription = document.getElementById("planetDescription");
  planetDescription.textContent = objeto.destinations[itemValue].description;
...
const renderCrew = (itemValue) => {
  ...
  crewName.textContent = objeto.crew[itemValue].name;
  let crewDescription = document.getElementById("crewDescription");
  crewDescription.textContent = objeto.crew[itemValue].bio;
};
...
const renderTech = (itemValue) => {
  ...
  techName.textContent = objeto.technology[itemValue].name;
